      ...
      <div className="h-full flex flex-col p-4">
                  ...
                  <div className="max-h-64 overflow-y-auto">
                    {roomUsers.map((u) => {
                      ...
                      return (
                        ...
                        >
                          <div className={`w-8 h-8 rounded-full ${campusColor} flex items-center justify-center text-xs font-bold text-white flex-shrink-0`}>
                            {u.user?.charAt(0)}
                          </div>
        ...
        <div className="flex-1 mb-4" data-demo="remote-area">
          {screenSharerSid ? (
            ...
            /* Normal Grid Mode */
            <div className={`grid ${getGridClass(visibleUsers.length)} gap-3 h-full`}>
              {visibleUsers.map((u) => (
                <VideoCard
                  key={u.sid}
                  stream={u.stream || null}
            ...
            <div className="h-full flex flex-col items-center justify-center bg-gray-900/50 rounded-xl border border-gray-800/40">
              ...
              <p className="text-gray-600 text-xs mt-1">Users will appear here when they join</p>
            </div>
          )}
        </div>
